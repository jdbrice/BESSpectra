...
void StSpectraSimPicoMaker::analyzeTrack( Int_t iNode, Int_t iGoodTrack ){
	//LOG_INFO << "StSpectraSimPicoMaker::analyzeTrack( " << iNode << ", " << iGoodTrack << ") " << endm;
 ...
 * Creates the Maker
 */
StSpectraSimPicoMaker::StSpectraSimPicoMaker( const Char_t *name="SpectraPicoMaker", const Char_t *outname="SpectraPico.root") : StSpectraSkimmer(name, outname) {
